...
public class JWTAuthenticatiinFilter extends UsernamePasswordAuthenticationFilter {
	
	private AuthenticationManager authenticationManager;
	
	public JWTAuthenticatiinFilter(AuthenticationManager authenticationManager) {
		super();
